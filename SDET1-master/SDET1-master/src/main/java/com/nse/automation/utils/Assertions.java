...
public class Assertions {
	...
	public void hardAssertTrue(boolean pageAssert, String stepDescription) {
		...
		if(stepDescription.contains("FAILED")) {
			captureScreenshot();
		}
	}

	public void hardAssertEquals(String actualValue, String expectedValue, String strSuccessMessage,
	...
	public void hardAssertNotEquals(String actualValue, String expectedValue, String strSuccessMessage,
			String strErrorMessage) {
		boolean result = !actualValue.equals(expectedValue);
		String stepDescription = result ? strSuccessMessage : strErrorMessage;
	...
	public void hardAssertEquals(String actualValue, String expectedValue, String stepDescription) {
		...
		String strErrorMessage = "FAILED: " + stepDescription + ". Expected: " + expectedValue + ", Actual: "
				+ actualValue;
	...
	/*
	 * @Step("{2}") public void softAssertEquals(String actualValue, String
	 * expectedValue, String stepDescription){ String strSuccessMessage =
	 * "Verified: " + stepDescription + " = " + actualValue; String strErrorMessage
	 * = "FAILED: " + stepDescription + ". Expected: " + expectedValue +
	 * ", Actual: " + actualValue; stepDescription =
	 * "Expected value '"+expectedValue+"', Retrieved value '" +actualValue+"' -- "
	 * +stepDescription;
	...
	public void softAssertEquals(String actualValue, String expectedValue, String strSuccessMessage,
			String strErrorMessage) {
	...
	private void logAssert(String stepDescription) {
		LoggerManager.info("*** " + stepDescription + "' ***");
	}
	...
	@Step("{2}")
	public void hardAssertFalse(boolean pageAssert, String strSuccessMessage, String strErrorMessage) {
		String stepDescription = !pageAssert ? strSuccessMessage : strErrorMessage;
		hardAssertFalse(pageAssert, stepDescription);
	}

	@Step("{0}")
	public void logInformationWithScreenShot(String stepDescription) {
		Reporter.log(stepDescription);
		captureScreenshot();
	}
